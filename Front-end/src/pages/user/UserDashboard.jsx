...
const UserDashboard = () => {
  ...
  return (
    <div className="container-fluid px-0 min-vh-100">
      {/* Mobile Header with Hamburger */}
      <div
        className="d-md-none bg-white text-black p-3 d-flex justify-content-between align-items-center position-sticky top-0"
        style={{
          zIndex: 1000,
          borderBottom: "1px solid rgba(219, 220, 221, 0.88)",
        }}
      >
      ...
      <div className="row g-0">
        {/* Left Side Navbar */}
        <div
          className={`col-md-3 col-lg-2 bg-white text-black  vh-100 position-fixed sidebar ${
            sidebarOpen ? "open" : ""
          }`}
          style={{ zIndex: 1000 }}
        >
          <div className="d-flex flex-column h-100 p-2 p-md-4 position-relative">
            {/* Profile Image - Desktop */}
            {!isMobile && (
              <div className="text-center mb-4">
                <img
            ...
            <ul className="nav flex-column mb-3" style={{ flex: "1 1 auto" }}>
              <li className="nav-item mb-2">
                <NavLink
                  to={`/my-project/user/${id}/dashboard`}
                  className={({ isActive }) =>
                    `nav-link text-black py-2 px-3 rounded d-flex align-items-center ${
                      isActive ? "active bg-primary" : ""
                    }`
                  }
                  onClick={closeSidebar}
      ...
      <style>{`
      .sidebar{
      border:1px solid rgba(219, 220, 221, 0.88) ;
      border-radius:0px 15px 15px 0px;
        box-shadow: 0 4px 12px rgba(127, 135, 136, 0.3);
      }
        .nav-link:hover {
          background-color: rgba(243, 243, 244, 0.89) !important;
        }
        .nav-link.active {
          background-color:rgba(238, 240, 243, 0.82) !important;
        }
